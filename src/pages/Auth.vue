...
const handleLogin = async () => {
  ...
  try {
    ...
    const response = await axios.post('https://api.stchub.ru/auth/login', {
...
const handleSignup = async () => {
  ...
  try {
    ...
    const response = await axios.post('https://api.stchub.ru/auth/registration', registrationData)
...
const handleVerifyEmail = async () => {
  ...
  loading.value = true
  try {
    const response = await axios.post('https://api.stchub.ru/auth/verify-email', {
      email: formData.email,
...
const resendCode = async () => {
  loading.value = true
  try {
    const response = await axios.post('https://api.stchub.ru/auth/resend-verify', {
      email: formData.email 
    })
...
const handleForgot = async () => {
  ...
  loading.value = true
  try {
    const response = await axios.post('https://api.stchub.ru/auth/forgot-password', {
      email: formData.email 
    })
...
const handleReset = async () => {
  ...
  loading.value = true
  try {
    const response = await axios.post('https://api.stchub.ru/auth/reset-password', {
      email: formData.email,
